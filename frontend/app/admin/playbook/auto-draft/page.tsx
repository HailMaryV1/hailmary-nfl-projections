...
// 2026-09-13, SiteHeader rendered once by admin/layout.tsx.
export default function AutoDraftPage() {
  return (
    <main className="mx-auto w-full min-w-0 max-w-6xl flex-1 p-4 sm:p-6">
      <div className="flex flex-wrap items-center gap-3">
        <Link href="/admin/playbook" className="rounded-full bg-navy-900 px-3.5 py-1.5 font-[family-name:var(--font-cond)] text-sm font-bold uppercase tracking-wide text-navy-400 hover:bg-navy-800">
          &larr; My Playbook
        </Link>
      </div>
